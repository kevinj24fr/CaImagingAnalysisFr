...
# NOTE: Validation functions (validate_probability, validate_calcium_trace,
# validate_calcium_traces_matrix, validate_positive_numeric, validate_positive_integer,
# validate_character, validate_character_vector, validate_logical) are now defined in
# validation.R for centralized validation handling
